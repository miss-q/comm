...
public class StringUtil {
	...
	public static String randomChineseString() throws UnsupportedEncodingException{
		...
		brr[0]=(byte) highPos;
		brr[1]=(byte) lowPos;
		String string = new String(brr, "GB2312");
		return string;
	//TODO 实现代码
	}
	
	public static String randomChineseStrings(int length) throws UnsupportedEncodingException {
	...
	public static String generateChineseName() throws UnsupportedEncodingException{
		...
		String name2=randomChineseStrings(2);
		return name1+name2;
	//TODO 实现代码
	}
}
